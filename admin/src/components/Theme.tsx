...
export default function Theme() {
    ...
    return (
        <button onClick={handleThemeChange} aria-label={themeBtn ? "Switch to light mode" : "Switch to dark mode"} className="bg-transparent border-none outline-none transition text-neutral-800 hover:text-[#c1a875] focus:text-[#c1a875] active:scale-95 cursor-pointer dark:text-white">
            {themeBtn
                ? <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-moon">
                    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
                </svg>
                : <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-sun">
