...
export default function About() {
    return (
        <div className="min-h-screen flex flex-col bg-[#faf8f6] font-montserrat">
            <NavBar />
            <div className="flex-1 w-full max-w-6xl mx-auto pt-12 pb-20 flex flex-col items-center">
                <h1 className="font-prata text-5xl text-[#181818] mb-10 text-center tracking-wide">About Us</h1>
                <p className="text-xl text-[#444] mb-14 text-center max-w-2xl">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8">
                    <section className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
                    ...
                    <section className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
                        ...
                        <ul className="list-disc pl-4 text-[#555] space-y-2 text-base text-left">
