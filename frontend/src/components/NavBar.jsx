                ...
                <div className="max-w-screen-xl mx-auto grid grid-cols-3 items-center py-4 px-6 min-h-[64px]">
                    ...
                    <div className="flex justify-end items-center gap-8">
                        ...
                        <button aria-label="Search" onClick={() => setSearchOpen(true)}>
                            <FiSearch size={20} alt="Search" className="w-5 cursor-pointer text-neutral-800 dark:text-white" />
                        </button>
                        {/* Profile */}
                        ...
                        <Link to="/cart" aria-label='Cart' className='relative'>
                            <FiShoppingCart size={20} alt="Cart" className="w-5 min-w-5 text-neutral-800 dark:text-white" />
                            {cartCount > 0 &&
                ...
                <div className="fixed inset-0 z-40 bg-black/40 lg:hidden">
                    ...
                    <div className="relative w-full bg-white dark:bg-neutral-800 h-full shadow-lg flex flex-col z-50 text-neutral-800 dark:text-white">
                        ...
                        <button className="absolute top-4 right-4" onClick={() => setMobileOpen(false)} aria-label="Close Menu">
                            <FiX size={20} alt="Close Menu" className='w-5 cursor-pointer text-neutral-800 dark:text-white' />
                        </button>
